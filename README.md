...
## 🚀 Getting Started
To get started with Event Explorer, follow these simple steps:

1. **Requirements**: Make sure you have an Android device with:
...
4. **Open Event Explorer**: Once installed, find the Event Explorer icon on your device and tap it to open the app.

5. **Start Exploring**: Begin browsing through events. Use the filters to find events that interest you.

## 🔍 Features
- **Event Filtering**: Easily filter events by location and category to find what you like.
- **Detailed Information**: Click on any event to view more details, including time, location, and ticket information.
- **User-Friendly Interface**: Enjoy a sleek and intuitive design using Material 3 components.
- **Light/Dark Mode Support**: Switch between light and dark modes based on your preference.
...
3. **Allow Installation**: If prompted, you may need to change your settings to allow installations from unknown sources.
4. **Run the APK**: Once downloaded, open the APK file and tap "Install" to begin the installation process.
...
## 🎊 Thank You
Thank you for choosing Event Explorer! We hope you enjoy exploring events near you.